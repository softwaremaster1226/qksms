...
import com.android.QKSMS.common.base.QkViewContract
...
//    fun aboutLongClicks(): Observable<*>
    fun setShowAvatar(): Observable<*>
    fun statistic(): Observable<*>
    fun statisticDialog(content: String): androidx.appcompat.app.AlertDialog?
