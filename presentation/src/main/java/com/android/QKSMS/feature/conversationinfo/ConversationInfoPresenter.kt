...
import com.android.QKSMS.extensions.asObservable
import com.android.QKSMS.extensions.mapNotNull
import com.android.QKSMS.feature.conversationinfo.ConversationInfoItem.ConversationInfoMedia
import com.android.QKSMS.feature.conversationinfo.ConversationInfoItem.ConversationInfoRecipient
import com.android.QKSMS.interactor.DeleteConversations
import com.android.QKSMS.interactor.MarkArchived
import com.android.QKSMS.interactor.MarkUnarchived
...
//                .observeOn(AndroidSchedulers.mainThread())
//                .autoDisposable(view.scope())
//                .subscribe{ address -> view.pickAvatar(address.toLong()) }
    }
