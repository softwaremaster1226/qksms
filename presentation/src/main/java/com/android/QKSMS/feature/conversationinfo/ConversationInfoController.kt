...
import com.android.QKSMS.common.util.extensions.scrapViews
import com.android.QKSMS.common.widget.FieldDialog
import com.android.QKSMS.databinding.ConversationInfoControllerBinding
import com.android.QKSMS.feature.blocking.BlockingDialog
import com.android.QKSMS.feature.conversationinfo.injection.ConversationInfoModule
...
class ConversationInfoController(
    ...
    override fun avatarClicks(): Observable<*> = adapter.avatarClicks
    override fun pickAvatar(id: Long) {
        val galleryIntent = Intent(Intent.ACTION_PICK)
        galleryIntent.type = "image/*"
        galleryIntent.addFlags(Intent.FLAG_GRANT_READ_URI_PERMISSION)
                .putExtra("id", id)
        activity?.startActivityForResult(galleryIntent, ConversationInfoActivity.PICKER_RESULT)
    }
