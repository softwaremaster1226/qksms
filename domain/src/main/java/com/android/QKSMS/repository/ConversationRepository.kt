...
interface ConversationRepository {
    ...
    fun getConversations(archived: Boolean = false, locked: Boolean = false): RealmResults<Conversation>
    ...
    fun markLocked(vararg threadIds: Long)

    fun markUnLocked(vararg threadIds: Long)
