...
import com.android.QKSMS.extensions.map
import com.android.QKSMS.extensions.removeAccents
import com.android.QKSMS.filter.ConversationFilter
...
class ConversationRepositoryImpl @Inject constructor(
    ...
    override fun getConversations(archived: Boolean, locked: Boolean): RealmResults<Conversation> {
        return Realm.getDefaultInstance()
                .where(Conversation::class.java)
                .notEqualTo("id", 0L)
                .equalTo("archived", archived)
                .equalTo("blocked", false)
                .equalTo("locked", locked)
    ...
    override fun markLocked(vararg threadIds: Long) {
        Realm.getDefaultInstance().use { realm ->
            val conversations = realm.where(Conversation::class.java)
                    .anyOf("id", threadIds)
                    .findAll()
    ...
    override fun markUnLocked(vararg threadIds: Long) {
        Realm.getDefaultInstance().use { realm ->
            val conversations = realm.where(Conversation::class.java)
                    .anyOf("id", threadIds)
                    .findAll()
